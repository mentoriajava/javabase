...
public interface CadeadosFortes {
     ...
     * @param locais O numero de locais de estacionamento disponiveis.
     * @return Um array com o ID dos cadeados mais fortes, em ordem de grandeza.
     */
    Integer[] buscarCadeadosFortes(Integer[][] cadeados, Integer[] chaves, Integer locais);
}
